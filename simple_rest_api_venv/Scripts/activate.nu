...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\dell\Documents\zur_1\Assignments\simple_rest_api_venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\dell\Documents\zur_1\Assignments\simple_rest_api_venv\Scripts\deactivate.nu'
